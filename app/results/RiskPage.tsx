  ...
  return (
    <div className="dash-page-inner" style={{
      ...
      <div>
        ...
        >
          These scenarios are grounded in documented practice.
        </motion.p>
        <motion.p
          initial={{ opacity: 0 }}
        ...
        >
          The systems are operational, legal, and commercially incentivised. The data that powers them was generated by you, collected under terms most people did not read, and cannot be recalled. What separates this from a conventional data breach: your conversations were not just stored. They were learned from. Learning cannot be undone.
        </motion.p>
        <div style={{
          marginTop: 'clamp(2.5rem, 5vw, 4rem)',
          ...
          <p style={{
            ...
            These scenarios assume the record leaves the system. The prior question is whether it can ever be fully removed. It cannot, even by those who hold it.
          </p>
